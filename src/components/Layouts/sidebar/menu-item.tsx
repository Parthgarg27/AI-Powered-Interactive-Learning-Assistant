...
export function MenuItem(
  ...
  const { toggleSidebar, isMobile, isCollapsed, isHovered } = useSidebarContext();
      ...
      <Link
        ...
        className={cn(
          menuItemBaseStyles({
            ...
            className: cn("relative block py-2", (isCollapsed && !isHovered) && "px-2"),
          }),
          props.className,
        )}
      >
  ...
  return (
    <button
      ...
      className={cn(
        menuItemBaseStyles({
          isActive: props.isActive,
          className: cn("flex w-full items-center gap-3 py-3", (isCollapsed && !isHovered) && "px-2 justify-center"),
        }),
        props.className,
      )}
    >
